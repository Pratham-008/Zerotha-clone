...
function footer() {
    return (<footer style={{ backgroundColor: "rgb(250,250,250)" }} className='border-top mt-4'><div className='container mt-5'>
        <div className='row mt-5'>
            <div className='col-3'><img src='media/logo.svg' width={"45%"}/><p className='mt-3'>© 2010 - 2025, Zerodha Broking Ltd.<br />All rights reserved.</p></div>
            <div className='col-3'><p>Company</p>
                ...
                <a href="" className='text-muted' style={{textDecoration:"none"}}>Zerodha Cares (CSR)</a></div>
            <div className='col-3'><p>Support</p>
                ...
                <a href="" className='text-muted' style={{textDecoration:"none"}}>Status of your complaints</a></div>
            <div className='col-3'><p>Account</p>
                <a href="" className='text-muted' style={{textDecoration:"none"}}>Open an account</a><br />
                <a href="" className='text-muted' style={{textDecoration:"none"}}>Fund transfer</a></div>
        </div>
        ...
        <div className='d-flex justify-content-center pb-4'>
            <a href='' className='ms-4 text-muted' style={{textDecoration:"none"}}>NSE      </a>
            <a href='' className='ms-4 text-muted' style={{textDecoration:"none"}}>BSE</a>
            <a href='' className='ms-4 text-muted' style={{textDecoration:"none"}}>MCX</a>
            <a href='' className='ms-4 text-muted' style={{textDecoration:"none"}}>Terms & conditions</a>
            <a href='' className='ms-4 text-muted' style={{textDecoration:"none"}}>Policies & procedures</a>
            <a href='' className='ms-4 text-muted' style={{textDecoration:"none"}}>Privacy policy</a>
            <a href='' className='ms-4 text-muted' style={{textDecoration:"none"}}>Disclosure</a>
            <a href='' className='ms-4 text-muted' style={{textDecoration:"none"}}>For investor's attention</a>
            <a href='' className='ms-4 text-muted' style={{textDecoration:"none"}}>Investor charter</a>
        </div>
    </div>
    </footer>);
}
